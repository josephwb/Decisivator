...
Note: the main function and the calcFit function are currently included only for testing purposes. The main function should be deleted and the calcFit function modified to return a measure of decisiveness.
